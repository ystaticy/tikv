...
pub mod test_utils {
    ...
    pub const TEST_KEYSPACE_LEVEL_GC_KEYSPACE_ID: u32 = 1;
    pub const TEST_GLOBAL_GC_KEYSPACE_ID: u32 = 2;
    ...
    pub fn make_keyspace_level_gc_service() -> Arc<KeyspaceLevelGCService> {
